...
// 💡 Importaciones para Sesión y Modelo
...
public class ProductosController extends BaseController {
    ...
    // ─────────────────────────────────────────────────────────
    //  Sistema de Permisos (Nivel 3: Productos)
    // ─────────────────────────────────────────────────────────
    private void configurarPermisos() {
        ...
        if (usuario != null && usuario.getPermisos() != null && usuario.getPermisos().length() >= 5) {
            // Sacamos el nivel del módulo de Productos (Posición 3)
            int nivel = Character.getNumericValue(usuario.getPermisos().charAt(3));
    ...
    @FXML public void crear() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/mx/nanosip/nanosip/CrProductos.fxml"));
            ...
            System.err.println("Error abriendo CrProductos: " + e.getMessage());
            e.printStackTrace();
        }
    }
