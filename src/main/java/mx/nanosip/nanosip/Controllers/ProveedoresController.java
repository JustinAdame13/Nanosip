...
// 💡 Importaciones para Sesión y Modelo en singular
...
public class ProveedoresController extends BaseController {
    ...
    public void initialize() {
        ...
        // 💡 Aplicamos los permisos al abrir la pantalla
        configurarPermisos();
    ...
    // ─────────────────────────────────────────────────────────
    //  Sistema de Permisos (Nivel 4: Proveedores)
    // ─────────────────────────────────────────────────────────
    private void configurarPermisos() {
        ...
        if (usuario != null && usuario.getPermisos() != null && usuario.getPermisos().length() >= 5) {
            // Sacamos el nivel del módulo de Proveedores (Posición 4)
            int nivel = Character.getNumericValue(usuario.getPermisos().charAt(4));
